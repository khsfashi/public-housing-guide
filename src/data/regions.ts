...
export const regionsData: SidoRegion[] = [
  {
    name: '서울시',
    sigungu: [
  ...
  {
    name: '부산시',
    sigungu: ['강서구', '금정구', '기장군', '남구', '동구', '동래구', '부산진구', '북구', '사상구', '사하구', '서구', '수영구', '연제구', '영도구', '중구', '해운대구']
  },
  {
    name: '대구시',
  ...
  {
    name: '충남도',
    sigungu: ['계룡시', '공주시', '금산군', '논산시', '당진시', '부여군', '서천군', '아산시', '예산군', '천안시 동남구', '천안시 서북구', '청양군', '태안군', '홍성군']
  },
  {
    name: '전북도',
  ...
  {
    name: '경북도',
    sigungu: ['경산시', '경주시', '고령군', '구미시', '김천시', '문경시', '봉화군', '상주시', '성주군', '안동시', '영덕군', '영양군', '영주시', '영천시', '예천군', '울릉군', '울진군', '의성군', '청도군', '청송군', '칠곡군', '포항시 남구', '포항시 북구']
  },
  {
    name: '경남도',
